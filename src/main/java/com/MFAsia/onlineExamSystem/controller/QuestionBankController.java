...
public class QuestionBankController {
	...
	public ResponseEntity<List<QuestionsBank>> getAllQuesions () {
		...
		if (list.isEmpty()) {
			return new ResponseEntity<List<QuestionsBank>>(headers,HttpStatus.NOT_FOUND);
		}
		return new ResponseEntity<List<QuestionsBank>>(list,HttpStatus.OK);
	}
	@GetMapping("/p")
	public List<Object> getAllQuesionsp () {
		return quesService.getAllQuestionP();
	}
	@PutMapping("/{id}")
